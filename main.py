...
CONTROLS, DEFINE, SHOW_CARDS, PLAYER_MOVE = range(4)
...
def main():
    conv_handler = ConversationHandler(
        ...
        states={
            ...
            CONTROLS: [MessageHandler(Filters.text & ~Filters.command, controls)],
            SHOW_CARDS: [MessageHandler(Filters.text & ~Filters.command, show_cards)]
        },
